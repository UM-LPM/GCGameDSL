...
abstract class GameDSLListener extends ParseTreeListener {
  ...
  /// Enter a parse tree produced by [GameDSLParser.gameStateAnnotation].
  /// [ctx] the parse tree
  void enterGameStateAnnotation(GameStateAnnotationContext ctx);
  /// Exit a parse tree produced by [GameDSLParser.gameStateAnnotation].
  /// [ctx] the parse tree
  void exitGameStateAnnotation(GameStateAnnotationContext ctx);
